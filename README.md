...
- 🚧 **Fase 3:** notificaciones locales ✅ · ajustes/gestión de cuenta ✅ (`app/settings.tsx`: editar signo/apodo/horario, recordatorio de ánimo independiente, borrar todos los datos) · AdMob ⏳.
